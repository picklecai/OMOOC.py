...
....是不是瞬间觉得邮件列表资源无限呢?! Come on! 快去邮件列表扒资源吧!
...
然后就开始向期待久矣的原创私用软件进发了哪!

- 和当周每天作的类似
    + 早晨想明白今天作什么
    + 到点儿,按照计划折腾
    + 定时完成团队日报,并公开
    + 当然的,通过 github 仓库 wiki 进行共笔起草,最后只是简单的复制发布到列表,最人性了.
- 遇到问题:
    + 先思考
    + 再尝试
    + 最后,认真 `公开讨论令众受益` ~ 来列表提问
- 唯一的变化就是:
    + 每天的代码产出
    + 就不仅仅是自个儿的了
    + 而是整个儿团队共同拥有的了
    + 必须确保所有人,都理解,并知道自个儿负责的功能怎么安全/合理的追加合并进来!
